...
Though some efforts were made to formalize the new language (see \cref{sec:semantics} for the formalized operational semantics), a lot more could be done in this area, with the ultimate goal being linking the operational and denotational semantics of the language to prove the soundness and adequacy of the implementation.
