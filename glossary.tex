...
\newglossaryentry{real}
{
    ...
    description={An element of $\R$, which can be defined as the completion of $\Q$ using Cauchy limits}
}
...
\newglossaryentry{cr_representation}
{
    ...
    description={A mathematical formalization of the concept of computable real (e.g. nested intervals representation, modulus of convergence representation)}
}

\newglossaryentry{cr_implementation}
{
    name={computable real implementation},
    description={A concrete implementation of a computable real representation strategy, usually offering functionality like arithmetic, comparison, etc (e.g. the packages analyzed in this thesis)}
}
...
{
    name={\textit{CompReal}},
    description={A Haskell typeclass defined for this thesis that abstractly encapsulates the concept and functionality of a computable real}
}
